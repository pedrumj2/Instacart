...
#
#mysql -u root -pfafdRE33 -e "
#    CREATE TABLE insta.combined2 
#    SELECT * FROM insta.combined
#    where user_id <=20000"
#    
    
mysql -u root -pfafdRE33 -e "
    drop table insta.combined"
    
mysql -u root -pfafdRE33 -e "
    ALTER TABLE insta.combined2 
    RENAME TO  insta.combined ;
    "